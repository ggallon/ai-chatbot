export const ArrowDownCircle = ({ size = 20 }: { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24.564 24.222"
      height={size}
      width={size}
      fill="currentColor"
    >
      <path d="M12.105 24.21c6.684 0 12.107-5.423 12.107-12.105S18.79 0 12.105 0C5.423 0 0 5.423 0 12.105S5.423 24.21 12.105 24.21Zm0-2.384a9.712 9.712 0 0 1-9.72-9.721 9.712 9.712 0 0 1 9.72-9.72 9.714 9.714 0 0 1 9.723 9.72 9.714 9.714 0 0 1-9.723 9.72Z" />
      <path d="M12.105 18.007c.277 0 .536-.085.81-.355l3.816-3.685c.204-.194.308-.4.308-.688 0-.54-.426-.92-.956-.92-.26 0-.53.11-.713.317l-1.644 1.75-.641.766.095-1.733V7.245c0-.566-.487-1.042-1.075-1.042-.584 0-1.063.476-1.063 1.042v6.214l.085 1.733-.643-.767-1.642-1.749a.987.987 0 0 0-.722-.317c-.53 0-.95.38-.95.92 0 .287.107.494.302.688l3.825 3.685c.272.27.534.355.808.355Z" />
    </svg>
  );
};
