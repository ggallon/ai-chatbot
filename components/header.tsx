...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 w-full shrink-0 items-center justify-between gap-3 border-b bg-gradient-to-b from-background/10 via-background/50 to-background/80 px-4 backdrop-blur-xl sm:gap-3.5">
      <div className="ai-effect inline-flex select-none items-center whitespace-nowrap">
        ...
        <Link href="/">
          <span className="font-bold lg:text-lg">
            <IconAi className="mb-0.5 mr-0 inline w-4 text-black sm:w-5" />
            AI
          </span>
        </Link>
      </div>
